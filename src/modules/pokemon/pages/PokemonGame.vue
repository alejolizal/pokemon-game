<template>
  ...
  <!--
    ¿Se verá la section 2?
    Sí, la segunda section (con el h1 "¿Quien es ese pokemon?") siempre se verá,
    porque la primera tiene v-if="false" y por lo tanto nunca se mostrará.
